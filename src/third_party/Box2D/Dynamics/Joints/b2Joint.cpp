...
b2Joint *b2Joint::Create(const b2JointDef *def, b2BlockAllocator *allocator) {
  ...
  case e_distanceJoint: {
    ...
    joint =
        new (mem) b2DistanceJoint(static_cast<const b2DistanceJointDef *>(def));
  } break;
  ...
  case e_revoluteJoint: {
    ...
    joint =
        new (mem) b2RevoluteJoint(static_cast<const b2RevoluteJointDef *>(def));
  } break;
  ...
  case e_frictionJoint: {
    ...
    joint =
        new (mem) b2FrictionJoint(static_cast<const b2FrictionJointDef *>(def));
  } break;
